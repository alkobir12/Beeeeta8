...
import { Car, User, Phone, Calendar, Wrench, CheckCircle, FileText, Upload, Printer, Receipt, Clock, Trash2, Camera, X, Scan, Plus, ChevronDown, ChevronUp, Edit2, Save, XCircle, MessageCircle } from 'lucide-react';
...
import {
  ...
  VehicleFinancialSourceModal,
  VehiclePrintMenu,
  VehiclePrintVisitPicker,
} from '../components/vehicle-details/VehicleDetailsChrome';
import { VehicleCustomerInfoCards } from '../components/vehicle-details/VehicleCustomerInfoCards';
        ...
        return (
          <div className="space-y-3" data-testid="vehicle-info-section">
            <VehicleCustomerInfoCards
              ...
              isVehicleInfoCollapsed={isVehicleInfoCollapsed}
              setIsVehicleInfoCollapsed={setIsVehicleInfoCollapsed}
              isCustomerInfoCollapsed={isCustomerInfoCollapsed}
              setIsCustomerInfoCollapsed={setIsCustomerInfoCollapsed}
              onSaveVehicle={handleUpdateVehicleInfo}
  ...
  return (
    <div className="vehicle-details-page mobile-first-vehicle w-full max-w-6xl mx-auto px-0 sm:px-4 pb-28 sm:pb-20 space-y-4 sm:space-y-6" style={{ direction: isRTL ? 'rtl' : 'ltr' }}>
      <VehicleDetailsStyles
        ...
        printVisitPickerOpen={printVisitPickerOpen}
        printDialogConfig={printDialogConfig}
      />

      {isArchiveSource && <ArchiveEditBanner />}
      ...
      <VehiclePrintMenu
        ...
        onPrint={handleHeaderPrintPress}
      />

      <VehiclePrintVisitPicker
        open={printVisitPickerOpen}
        visits={visits}
        pendingHeaderPrintType={pendingHeaderPrintType}
        onClose={() => { setPrintVisitPickerOpen(false); setPendingHeaderPrintType(''); }}
        onPick={openHeaderPrintDialog}
      />
      ...
      {/* Modals */}
      <VehicleFinancialSourceModal
        open={financialSourceOpen}
        title={financialSourceTitle}
        rows={financialSourceRows}
        onClose={() => setFinancialSourceOpen(false)}
      />
      ...
      <ScannerModal
        ...
        uploadScannedImage={uploadScannedImage}
        closeScanner={closeScanner}
      />

      <PreviewOverlay previewImage={previewImage} onClose={() => setPreviewImage(null)} />
      ...
      <QuickPrintDialog
        ...
        open={Boolean(printDialogConfig)}
        ...
        onClose={() => setPrintDialogConfig(null)}
      />
