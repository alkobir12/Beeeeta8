...
Testing Environment: https://pdpl-memory-engine.preview.emergentagent.com
...
class ComprehensiveBackendTester:
    def __init__(self):
        ...
        self.base_url = "https://pdpl-memory-engine.preview.emergentagent.com"
    ...
    def test_cors_preflight(self):
        ...
        try:
            headers = {
                'Origin': 'https://pdpl-memory-engine.preview.emergentagent.com',
    ...
    def run_all_tests(self):
        ...
        print("🎯 Target: https://pdpl-memory-engine.preview.emergentagent.com")
        print("=" * 80)
