...
Testing Environment: https://stamp-approval-flow.preview.emergentagent.com
...
class ComprehensiveBackendTester:
    ...
    def test_cors_preflight(self):
        ...
        try:
            headers = {
                'Origin': 'https://stamp-approval-flow.preview.emergentagent.com',
    ...
    def run_all_tests(self):
        ...
        print("🎯 Target: https://stamp-approval-flow.preview.emergentagent.com")
        print("=" * 80)
