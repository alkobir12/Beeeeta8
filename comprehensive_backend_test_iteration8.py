...
Testing Environment: https://erp-compliance-check.preview.emergentagent.com
...
class ComprehensiveBackendTester:
    ...
    def test_cors_preflight(self):
        ...
        try:
            headers = {
                'Origin': 'https://erp-compliance-check.preview.emergentagent.com',
    ...
    def run_all_tests(self):
        ...
        print("🎯 Target: https://erp-compliance-check.preview.emergentagent.com")
        print("=" * 80)
