...
async def test_journal_entries():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.goto('https://pdpl-memory-engine.preview.emergentagent.com/login')
            ...
            await page.wait_for_url('https://pdpl-memory-engine.preview.emergentagent.com/', timeout=15000)
            print("✅ Login successful")
            
            # Step 2: Navigate to Journal Entries
            print("2. Navigate to Journal Entries page...")
            await page.goto('https://pdpl-memory-engine.preview.emergentagent.com/accounting/journal-entries')
