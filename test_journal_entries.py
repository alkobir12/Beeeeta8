...
async def test_journal_entries():
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.goto('https://erp-compliance-check.preview.emergentagent.com/login')
            ...
            await page.wait_for_url('https://erp-compliance-check.preview.emergentagent.com/', timeout=15000)
            print("✅ Login successful")
            
            # Step 2: Navigate to Journal Entries
            print("2. Navigate to Journal Entries page...")
            await page.goto('https://erp-compliance-check.preview.emergentagent.com/accounting/journal-entries')
