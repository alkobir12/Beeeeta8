...
def test_vehicle_financial_summary():
    ...
    try:
        vehicles_response = requests.get("https://workshop-helper-7.preview.emergentagent.com/api/vehicles")
        if vehicles_response.status_code == 200:
            ...
            if vehicles:
                ...
                financial_response = requests.get(f"https://workshop-helper-7.preview.emergentagent.com/api/vehicles/{vehicle_id}/financial-summary")
