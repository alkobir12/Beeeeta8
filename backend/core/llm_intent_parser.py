...
_SYSTEM_PROMPT = (
    ...
    "  • أرقام اللوحات السعودية: 3-4 أرقام + 2-4 حروف (مثل: '1234 ABC' أو 'أ ب ج 1234').\n"
    ...
    "  • أرقام الجوال السعودية تبدأ بـ 05 (10 أرقام) أو +9665.\n\n"
    "Actions المسموح بها:\n"
    "  • create_customer  — payload: {name, phone, email?, address?, vehicle_plate?}\n"
    "  • create_vehicle   — payload: {plate, brand?, model?, year?, vehicle_type?, customer_name?}\n"
    ...
    "  3. إذا كانت الجملة فيها خدمة + سيارة + سعر → استخدم create_visit (وليس create_vehicle).\n"
    "  4. إذا غير واضح: action='unknown' و payload={}.\n"
    "  5. لا تخترع حقولاً غير الموجودة في الـ payload المسموح به أعلاه.\n"
    "  6. الأسماء العربية تُحفظ كما هي (UTF-8).\n"
    "  7. أرقام الهواتف بصيغة 05xxxxxxxx فقط (10 أرقام).\n"
    "  8. plate = رقم اللوحة فقط (4-5 أرقام + ربما حروف). لا تضع نوع السيارة في plate.\n\n"
    "أمثلة:\n"
