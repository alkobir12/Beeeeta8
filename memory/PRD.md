...
- **P1**: حوكمة كاترينا المرحلة C المتبقية إن وُجدت + ربط أداة whatsapp.send بموجّه نوايا البوت
- **P2**: تنظيف حسابات الموردين الاختبارية DDD-TEST-* من جدول accounts
- **P2**: deep-links سياقية (?pos= ?part=)؛ «الطلبات الافتراضية» — بانتظار تعريف المستخدم
