...
|---|---|---:|---:|---:|---:|---:|---|---|
| لوحة التحكم | /api/vehicles, /api/technicians, /api/finance/ar/customers | 17 | 17 | 17 | 0 | 5 | FAIL | dashboard_count لا يطابق العدد المعتمد من المستخدم |
...
| متابعة الذمم والتحصيل | /api/finance/ar/customers, /api/finance/ar/ledger | 11 | 11671.0 | 12548.0 | 0 | 5 | BLOCKER |  |
...
| العملاء وأرصدة العملاء المقدمة | /api/customers, /api/finance/ar/customers | 218 | 169.0 | 169.0 | 0 | 5 | WARNING | account not created by design in P0.2 |
...
| BLOCKER | dashboard_count_mismatch_with_user_gate | `{"severity": "BLOCKER", "type": "dashboard_count_mismatch_with_user_gate", "expected": 12, "actual": 17, "note": "لا يمكن اعتماد P0.2 كبوابة P1 لهذه البيئة حتى يتطابق عدد لوحة التحكم مع العدد المعتمد من المستخدم أو يثبت فلتر مختلف."}` |
...
## ملف JSON
- `/app/test_reports/p02_preview_financial_audit_raw.json`